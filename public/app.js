...
document.addEventListener('click', async event => {
  ...
  try {
    ...
    if (action === 'use-extraction') { const m = state.data.messages.find(m => m.id === target.dataset.id); state.extract = m.extraction; state.form = { clientId: m.clientId, params: m.extraction.params, scenario: 'success' }; state.draft = null; go('/new'); }
